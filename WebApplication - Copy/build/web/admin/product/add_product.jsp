...
<br/>
<br/>
<form name="frmLogin" id="frmLogin" method="post" action="../ProductServlet">
    <table border="0" class="regitable">
        ...
        <tr>
            ...
            <td>
                <select name="txtImage" id="txtImage" onchange="setImage()" >
                    <option>--please select--</option> 
        ...
        <tr>
            ...
            <td id="lable" colspan="2"><input type="text" name="txtEntryDate" value="<%=entryDate%>"></td>
        </tr>
        <tr>
